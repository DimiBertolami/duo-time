...
document.getElementById('change4').innerHTML = "Confident";
...
document.getElementsByTagName('h1')[0].innerHTML = "On this page i would like to present a few things about my dear colleague Lau";
document.getElementsByTagName('h3')[1].innerHTML = "Because sometimes a picture says more than 1000 words, you can see here his spirit animal!";
...
/*let myDiv = document.getElementsByClassName('row favoriteFictionalCharacter');
let sunglasses = document.createElement('div');
myDiv.appendChild('sunglasses');
let l = document.createElement('div');
l.setAttribute("id", "left");
l.setAttribute('style', 'div{width:100px;height:100px;border-radius:50%;background:rgb(0,255,183);position:relative;left:400px;top:100px;}')
let r = document.createElement('div');
r.setAttribute("id", "right");
let m = document.createElement('div');
m.setAttribute("id", "middle");
let rl = document.createElement('div');
rl.setAttribute("id", "rightLens");
let ll = document.createElement('div');
ll.setAttribute("id", "leftLens");
sunglasses.appendChild(l);
*/